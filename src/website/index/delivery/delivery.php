...
<?php 
    ...
    $dsn = 'mysql:dbname=sql7381971;host=localhost';
    $user = 'localhost';
    $password = 'password';
                   ...
                   <form action="delivery.php" method="post"> 
                    ...
                    <div class="form-group input-group">
                      ...
                      <!--        <span class="input-group-text"> <i class="fa fa-lock"></i> </span> -->
                        ...
                        <input type="date" placeholder="inserire data" class="form-control" name="data" id="data" required>
                    </div> <!-- form-group// -->
                    ...
                    <input type="text" placeholder="inserisci note" class="form-control" name="note" id="note" required>
                    </div> <!-- form-group// -->
